import { Annotation, Board, MatchNode, MatchState, Move, PgnTag, Piece, Side, Square } from '.';
    ...
    const getPGNMoveList = function(node: MatchNode, addMoveCounterHeader = true): string {
      ...
      for (const move of moves) {
        ...
        if (onMainLine) {
          ...
          const variationMoveLine = getPGNMoveList(childNode, addChildNodeMoveCounterHeader);
